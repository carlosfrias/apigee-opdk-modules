...
def main():
  module = AnsibleModule(
      argument_spec=dict(
          apigee_host=dict(required=False, type='str', default='http://api.enterprise.apigee.com'),
          version=dict(required=False, type='str'),
          directory=dict(required=False, type='str', default='apiproxy'),
          zip_file = dict(required=False, type='str'),
          user_name = dict(required=True, type='str'),
          password = dict(required=True, type='str'),
          organization = dict(required=True, type='str'),
          environment = dict(required=True, type='str'),
          name = dict(required=True, type='str'),
          base_path = dict(required=False, type='str', default='/'),
          should_deploy = dict(required=False, type='bool', default=True)
      )
  )

  ApigeeHost = module.params['apigee_host']
  UserPW = module.params['password']
  Directory = module.params['directory']
  Organization = module.params['organization']
  Environment = module.params['environment']
  Name = module.params['name']
  BasePath = module.params['base_path']
  ShouldDeploy = module.params['should_deploy']
  ZipFile = module.params['zip_file']
